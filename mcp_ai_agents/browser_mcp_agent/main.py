...
with st.sidebar:
    ...
    st.markdown("- Go to github.com/hamzach9410/LLM-PROJECTS-PACK")
    ...
    st.markdown("- Navigate to github.com/hamzach9410/LLM-PROJECTS-PACK, scroll down, and report details")
